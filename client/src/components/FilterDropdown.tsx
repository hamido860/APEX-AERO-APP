  ...
  return (
    <div className="relative group/filter" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          id={menuId}
          className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-slate-800/90 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-lg shadow-2xl p-2 z-50"
        >
          ...
          <div className="max-h-60 overflow-y-auto pr-1">
            {options.map((option) => (
              ...
              >
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded bg-slate-200 dark:bg-slate-600 border-slate-300 dark:border-slate-500 text-cyan-600 dark:text-cyan-500 focus:ring-cyan-500"
