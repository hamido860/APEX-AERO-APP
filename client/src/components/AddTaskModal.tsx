        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm" onClick={onClose}>
            ...
            >
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <h2 id="add-task-modal-title" className="text-xl font-bold text-slate-900 dark:text-slate-100 transition-colors duration-300">{t('addTaskModal.title')}</h2>
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="text" id="name" name="name" value={task.name} onChange={handleChange} required autoFocus className="bg-slate-700 rounded-md p-2 text-white focus:ring-2 focus:ring-cyan-500 outline-none" />
                    </div>
                    <div className="flex flex-col">
