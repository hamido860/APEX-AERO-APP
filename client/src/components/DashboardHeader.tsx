        ...
        <>
            <div className="flex items-center gap-2">
                 {currentView === 'gantt' && filters && onFilterChange && onClearFilters && (
                    <div className="flex items-center gap-1.5">
                        <FilterDropdown label={t('ganttFilters.program')} options={uniquePrograms} selected={filters.program} onToggle={(option) => onFilterChange('program', option)} icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" /></svg>} />
                        <FilterDropdown label={t('ganttFilters.subProgram')} options={uniqueSubPrograms} selected={filters.subProgram} onToggle={(option) => onFilterChange('subProgram', option)} icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clipRule="evenodd" /><path d="M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z" /></svg>} />
                        <FilterDropdown label={t('ganttFilters.operator')} options={allOperators} selected={filters.operator || []} onToggle={(option) => onFilterChange('operator', option)} icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" /></svg>} />
                        <FilterDropdown label="Status" options={['To Do', 'In Progress', 'Completed', 'Quality OK', 'On Hold']} selected={filters.status || []} onToggle={(option) => onFilterChange('status', option)} icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-14-14zM2 10a8 8 0 1116 0 8 8 0 01-16 0z" clipRule="evenodd" /></svg>} />
                 ...
                 {canToggleColumns && columnVisibility && columnConfig && (
                   <div className="relative" ref={columnMenuRef}>
                       ...
                       {isColumnMenuOpen && (
                           <div id="column-menu" className="absolute top-full left-0 mt-2 w-56 bg-slate-900/80 backdrop-blur-sm border border-slate-700 rounded-lg shadow-2xl p-2 z-50">
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
                <div className="hidden sm:flex items-center gap-1.5 px-2 py-1">
                    <span className="text-[11px] font-medium text-slate-600 dark:text-slate-300">{currentDate}</span>
                    <div className="w-px h-3.5 bg-slate-200 dark:bg-slate-700"></div>
                    <span className="text-[11px] font-medium text-slate-600 dark:text-slate-300">{t('header.week', weekNumber)}</span>
                </div>
                 <div className="relative group/lang" ref={langMenuRef}>
                    ...
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 px-2 py-1 bg-slate-900 dark:bg-slate-700 text-white text-[10px] font-medium rounded-md whitespace-nowrap opacity-0 invisible group-hover/lang:opacity-100 group-hover/lang:visible transition-all duration-150 pointer-events-none z-50 shadow-lg">
                        {t('language')}
                        <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-slate-900 dark:bg-slate-700 rotate-45"></div>
                    </div>
                    {isLangMenuOpen && (
                         <div id="lang-menu" className="absolute top-full right-0 mt-2 w-36 bg-white dark:bg-slate-900/90 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-lg shadow-2xl p-2 z-50">
                 ...
                 <div className="relative group/theme">
                    ...
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 px-2 py-1 bg-slate-900 dark:bg-slate-700 text-white text-[10px] font-medium rounded-md whitespace-nowrap opacity-0 invisible group-hover/theme:opacity-100 group-hover/theme:visible transition-all duration-150 pointer-events-none z-50 shadow-lg">
                 ...
                 <div className="relative group/info">
                    ...
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 px-2 py-1 bg-slate-900 dark:bg-slate-700 text-white text-[10px] font-medium rounded-md whitespace-nowrap opacity-0 invisible group-hover/info:opacity-100 group-hover/info:visible transition-all duration-150 pointer-events-none z-50 shadow-lg">
                        {t('header.scheduleInfo') || 'Schedule Info'}
                        <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-slate-900 dark:bg-slate-700 rotate-45"></div>
                    </div>
                 </div>
                 <div className="relative group/print">
                    ...
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 px-2 py-1 bg-slate-900 dark:bg-slate-700 text-white text-[10px] font-medium rounded-md whitespace-nowrap opacity-0 invisible group-hover/print:opacity-100 group-hover/print:visible transition-all duration-150 pointer-events-none z-50 shadow-lg">
                        {t('header.printSchedule')}
                        <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-slate-900 dark:bg-slate-700 rotate-45"></div>
                    </div>
                 </div>
                 <div className="relative group/save">
                    ...
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 px-2 py-1 bg-slate-900 dark:bg-slate-700 text-white text-[10px] font-medium rounded-md whitespace-nowrap opacity-0 invisible group-hover/save:opacity-100 group-hover/save:visible transition-all duration-150 pointer-events-none z-50 shadow-lg">
                        {t('actions.save')}
                        <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-slate-900 dark:bg-slate-700 rotate-45"></div>
                    </div>
                 </div>
