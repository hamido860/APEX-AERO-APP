...
const ScheduleInfoModal: React.FC<ScheduleInfoModalProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/20 dark:bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-300"
      onClick={onClose}
    >
      <div
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2
                ...
                className="text-lg font-bold text-slate-900 dark:text-white tracking-tight uppercase transition-colors duration-300"
              >
                {t("scheduleInfo.title") || "Schedule Info"}
              </h2>
              <p className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest transition-colors duration-300">
                {t("scheduleInfo.subtitle") || "Operational Status"}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 text-center relative overflow-hidden group transition-colors">
            ...
            <p className="text-4xl font-bold text-slate-900 dark:text-white tracking-tight mb-1 tabular-nums transition-colors duration-300">
              {formattedTime}
            </p>
            <p className="text-xs font-bold text-cyan-500 uppercase tracking-[0.2em]">
              {formattedDate}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="flex items-start gap-4 p-4 bg-slate-800/30 rounded-2xl border border-slate-800/50">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1 transition-colors duration-300">
                  {t("scheduleInfo.workingHours") || "Standard Working Hours"}
                </h4>
            ...
            <div className="flex items-start gap-4 p-4 bg-slate-800/30 rounded-2xl border border-slate-800/50">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1 transition-colors duration-300">
                  {t("scheduleInfo.breaks") || "Scheduled Breaks"}
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed transition-colors duration-300">
                  12:00 - 13:00 (Lunch Break)
                </p>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed transition-colors duration-300">
                  10:15 - 10:30, 15:15 - 15:30 (Short Breaks)
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-slate-800/30 rounded-2xl border border-slate-800/50">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1 transition-colors duration-300">
                  {t("scheduleInfo.nonWorking") || "Non-Working Days"}
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed transition-colors duration-300">
        ...
        <div className="bg-slate-50 dark:bg-slate-950 px-8 py-6 border-t border-slate-200 dark:border-slate-800 flex justify-end transition-colors">
          <button
            ref={closeButtonRef}
            onClick={onClose}
            className="px-6 py-2.5 bg-slate-800 hover:bg-slate-700 text-white text-xs font-bold uppercase tracking-widest rounded-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
          >
