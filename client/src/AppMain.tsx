          ...
          {navItems.map(item => (
            <div key={item.id} className="relative group flex-1 flex justify-center">
              <button
                ...
                className={`flex items-center justify-center w-9 h-9 rounded-lg transition-all duration-200 relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 ${
                  currentView === item.id 
